...
public class PedidoNegocio {
	...
	public void salvar(Pedido novoPedido, Cupom cupom) {
		...
		String codPedido = "PE%04d%02d%04d";
		LocalDate hoje = LocalDate.now();
		codPedido = String.format(codPedido, hoje.getYear(), hoje.getMonthValue(), bancoDados.getPedidos().length);
		// Setar código no pedido
		novoPedido.setCodPedido(codPedido);
